...
function ProductForm({variantId}) {
  ...
  // useFetcher is an important Remix utility that enables you to fetch and post data to other routes.
  // useFetcher can act as a simple form replacement.
  // This component posts to the /cart action function you setup in the previous step.
...
export const loader = async ({params, context, request}) => {
  ...
  // The web standard URLSearchParams object passes the value, and then the key to the function.
  // This code block names them as value and name as required by the Storefront API selectedOptionInput input
...
// This query fetches data for the product display page, including descriptive details, images, and options data.
