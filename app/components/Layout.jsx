...
export function Layout({children, title}) {
  const {isOpen, openDrawer, closeDrawer} = useDrawer(); // this is a new hook that returns the state of the drawer
  const fetchers = useFetchers(); // this is a new hook that returns all the fetchers from the current route
  const [root] = useMatches(); // this is a new hook that returns the current route
  const cart = root.data?.cart; // this is the cart data from the root route
